...
function TermsOfService() {
  return (
    <DocumentContainer>
      <DocumentContainer.Title>Terms of Service</DocumentContainer.Title>
      <p>
        Welcome to&nbsp;
        <a href="https://app.narfex.com" target="_blank">
          https://app.narfex.com/
        </a>
        , a website-hosted user interface (the "Interface" or "App") provided by
        Narfex Inc ("we", "our", or "us"). The Interface provides access to a
        decentralized protocol on the BSC blockchain that allows users to trade
        certain digital assets ("the Narfex protocol" or the "Protocol"). The
        Interface is one, but not the exclusive, means of accessing the
        Protocol.
      </p>
      <DocumentContainer.Br type="large" />
      <p>
        ...
        to access or use the Interface and should not use the Interface.
      </p>
      <DocumentContainer.Br type="large" />
      <p>
        <strong>NOTICE:</strong> Please read this Agreement carefully as it
        governs your use of the Interface. This Agreement contains important
        ...
        resolved. The Interface is only available to you — and you should only
        access the Interface — if you agree completely with these terms.
      </p>
      ...
      <p>
        ...
        current version of the Agreement at https://app.narfex.com/terms. All
        modifications will be effective when they are posted, and your continued
        accessing or use of the Interface will serve as confirmation of your
      ...
      <p>
        ...
        old) and have the full right, power, and authority to enter into and
      ...
      <p>
        ...
        trademarks, service marks, copyrights, patents, and designs. This
        intellectual property is available under the terms of our copyright
        licenses and our Trademark Guidelines. Unlike the Interface Narfex
        protocol is composed entirely of open-source or source-available
        software running on the public BCS blockchain.
      </p>
      ...
      <p>
        ...
        disable, delete and remove any and all content and information from the
      ...
      <h2>Privacy</h2>
      <p>
        When you use the Interface, the only information we collect from you is
        your blockchain wallet address, completed transaction hashes, and the
        token names, symbols, or other blockchain identifiers of the tokens that
        you swap. We do not collect any personal information from you (e.g.,
        your name or other identifiers that can be linked to you). We do,
        however, use third-party service providers, like Infura, Cloudflare, and
        Google Analytics, which may receive or independently obtain your
        personal information from publicly-available sources. We do not control
        how these third parties handle your data and you should review their
        privacy policies to understand how they collect, use, and share your
        personal information. In particular, please visit
        https://policies.google.com/technologies/partner-sites to learn more
      ...
      <p>
        ...
        the BSC blockchain, which provides transparency into your transactions.
        Narthex Inc. does not control and is not responsible for any information
        you make public on the BSC blockchain by taking actions through the
        Interface.
      </p>
      ...
      <p>
        ...
        applicable law, rule, or regulation concerning the trading of securities
        or derivatives.
      </p>
      <DocumentContainer.Br />
      <p>
      ...
      <h2>Not Registered with the SEC or Any Other Agency</h2>
      <p>
        ...
        understand and acknowledge that we do not DocumentContainer.Broker
        trading orders on your behalf nor do we collect or earn fees from your
        trades on the Protocol. We also do not facilitate the execution or
        settlement of your trades, which occur entirely on the public
        distributed BSC blockchain.
      </p>
      <h2>Non-Solicitation; No Investment Advice</h2>
      <p>
        ...
        received any investment advice from us in connection with any trades,
        including those you place via our Auto Router API, and that we do not
      ...
      <p>
        ...
        contained in the Interface. We do not make any investment
      ...
      <p>
        The Interface is operated from facilities within the United States. The
        Interface may not be available or appropriate for use in other
      ...
      <p>
        ...
        intricacies of digital assets such as bitcoin (BTC), ether (ETH), and
        other digital tokens such as those following the Ethereum Token Standard
        (ERC-20). In particular, you understand that blockchain-based
        transactions are irreversible.
      </p>
      <DocumentContainer.Br type="large" />
      <p>
        You further understand that the markets for these digital assets are
        highly volatile due to factors including (but not limited to) adoption,
        speculation, technology, security, and regulation. You acknowledge and
        ...
        are not responsible for any of these variables or risks, do not own or
        control the Protocol, and cannot be held liable for any resulting losses
        that you experience while accessing or using the Interface. Accordingly,
      ...
      <h2>Third-Party Resources and Promotions</h2>
      <p>
      ...
      <p>
        ...
        must contact us by sending an email to support.narfex.com so that we can
      ...
      <p>
        ...
        this Agreement, or any other acts or omissions for which you may contend
        that we are liable, including (but not limited to) any claim or
        ...
        Arbitration Procedures. You understand that you are required to resolve
        all Disputes by binding arbitration. The arbitration shall be held on a
        confidential basis before a single arbitrator, who shall be selected
        pursuant to JAMS rules. The arbitration will be held in New York, New
        York, unless you and we both agree to hold it elsewhere. Unless we agree
        otherwise, the arbitrator may not consolidate your claims with those of
        any other party. Any judgment on the award rendered by the arbitrator
        may be entered in any court of competent jurisdiction.
      </p>
      <h2>Class Action and Jury Trial Waiver</h2>
      <p>
        You must DocumentContainer.Bring any and all Disputes against us in your
        individual capacity and not as a plaintiff in or member of any purported
        class action, collective action, private attorney general action, or
        other representative proceeding. This provision applies to class
        arbitration. You and we both agree to waive the right to demand a trial
        by jury.
      </p>
      <h2>Governing Law</h2>
      <p>
