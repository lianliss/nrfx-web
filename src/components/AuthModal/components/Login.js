    ...
    <>
      ...
      <div className="AuthModal__content">
        ...
        <UI.Input
          ...
          placeholder={utils.getLang(
            "site__authModalPlaceholderEmailOrUsername"
          )}
        ...
        {isProduction && (
          <Captcha
            ref={captchaRef}
            onChange={token => handleChange(token, "token")}
          />
        )}

        <h4
          className="AuthModal__help_link"
          onClick={() => changeStep(steps.RESTORE_PASSWORD)}
        >
          {utils.getLang("site__authModalForgotPwd")}
        </h4>
      </div>
      ...
      <div className="AuthModal__footer">
        <h4
          ...
          onClick={() => changeStep(steps.REGISTRATION)}
        >
