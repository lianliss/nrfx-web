...
export default class ImageUpload extends React.Component {
  ...
  _handleSubmit = (e) => {
    ...
    uploader.setRequestHeader('Accept-Language', window.localStorage.lang || 'en');
  ...
  render() {
    ...
    return (
      <div className="UploadAvatar__padding_preview">
        <form name="uploadPhotoForm" id="uploadPhotoForm" ref={this.uploadPhotoForm} onSubmit={(e)=>this._handleSubmit(e)}>
          <input
            style={{display:'none'}}
            ref={this.fileInput}
            className="fileInput"
          ...
          <div className="UploadAvatar__padding">
          </div>
          <div className="UploadAvatar__button">
            {!this.state.file ? <UI.Button
