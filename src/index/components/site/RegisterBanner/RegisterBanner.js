  ...
  return (
    <div className={className}>
      <div className="RegisterBanner__content">
        <div className="RegisterBanner__title">{getLang('site__registerBannerTitle')}</div>
        <div className="RegisterBanner__caption">{getLang('site__registerBannerCaption')}</div>
        <div className="RegisterBanner__form">
          ...
          }} className="RegisterBanner__form__button">{getLang('site__registerBannerBtn')}</div>
        </div>
      </div>
    </div>
  )
