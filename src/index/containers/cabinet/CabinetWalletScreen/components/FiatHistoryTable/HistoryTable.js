      ...
      {Object.keys(transactions).map(key => (
        <div className="FiatHistoryTable__group">
          ...
          {transactions[key].map(item => {
            ...
            return (
              <div key={item.id} onClick={() => openModal('fiat_operation', null, { operation: item, icon })} className="FiatHistoryTable__group__item">
                ...
                {item.type === 'income' ? (
                  ...
                  <div className="FiatHistoryTable__group__item__body">
                    <div className="FiatHistoryTable__group__item__left">
                      ...
                      <div className="FiatHistoryTable__currency">{utils.getLang('cabinet_fiatWalletGave')} {primaryCurrency.name}</div>
                    </div>
                    <div className="FiatHistoryTable__group__item__right">
                      ...
                      <div className="FiatHistoryTable__currency">{utils.getLang('cabinet_fiatWalletGot')} {secondaryCurrency.name}</div>
                    </div>
                  </div>
                )}
              </div>
