      ...
      <div>
        ...
        <Section title="Buttons">
          ...
          <Line>
            ...
            <UI.Button size="small" type="lite">Button</UI.Button>
          </Line>
          <Line>
            ...
            <UI.Button size="small" type="lite" currency="btc">Button</UI.Button>
          </Line>
          <Line>
            ...
            <UI.Button size="small" type="lite" currency="eth">Button</UI.Button>
          </Line>
          <Line>
            ...
            <UI.Button size="small" type="lite" currency="ltc">Button</UI.Button>
          </Line>
        </Section>
