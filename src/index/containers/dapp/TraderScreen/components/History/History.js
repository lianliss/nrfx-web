        ...
        >
          {history.map(h => (
            <UI.TableCell key={h.id}>
              <UI.TableColumn>
                <UI.NumberFormat number={h.price} type={h.side} />
              </UI.TableColumn>
              <UI.TableColumn align="right">
                <UI.NumberFormat number={h.amount} />
              </UI.TableColumn>
              <UI.TableColumn align="right">
                <UI.NumberFormat number={h.percent} percent />
              </UI.TableColumn>
              <UI.TableColumn align="right">
                {h.profit !== 0 ? (
                  <UI.NumberFormat number={h.profit} currency={"usd"} />
                ) : (
                  "-"
                )}
              </UI.TableColumn>
              <UI.TableColumn align="right">
                {utils.dateFormat(h.created_at)}
              </UI.TableColumn>
            </UI.TableCell>
          ))}
        </UI.Table>
