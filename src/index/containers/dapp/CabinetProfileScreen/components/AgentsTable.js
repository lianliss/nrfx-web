...
export default function AgentsTable({ agents, adaptive }) {
  ...
  let headings = [
    <UI.TableColumn>Agent</UI.TableColumn>,
    <UI.TableColumn>Customers</UI.TableColumn>,
    <UI.TableColumn align="right">Profit Summary</UI.TableColumn>,
  ...
  if (adaptive) {
    headings = [
      <UI.TableColumn sub="Partners">Agent</UI.TableColumn>,
      <UI.TableColumn sub="Date">Profit</UI.TableColumn>
    ];
  }
    ...
    rows = agents.map((item, i) => {
      return (
        ...
        >
          ...
          <UI.TableColumn
            align="right"
            sub={utils.dateFormat(item.created_at, "DD MMM YYYY")}
          >
    ...
    rows = agents.map((item, i) => {
      return (
        ...
        >
          ...
          <UI.TableColumn>{item.partners_count}</UI.TableColumn>
