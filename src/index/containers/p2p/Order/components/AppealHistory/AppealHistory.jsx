  ...
  return (
    <CabinetBlock className={styles.AppealHistory}>
      ...
      <CabinetScrollBlock
        ...
        right="0px"
        top="0px"
        maximalThumbSize={null}
        minimalThumbSize={null}
        className={styles.AppealHistory__scrollBlock}
      >
        <div className={styles.AppealHistory__messages}>
          {testMessageComponents}
          {testMessageComponents}
          {testMessageComponents}
        </div>
      </CabinetScrollBlock>
