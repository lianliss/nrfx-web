...
export default class SiteExchangeScreen extends BaseScreen {
    ...
    return (
      <div>
        <div className="Layout_spacing">
          ...
          <h2 className="SiteExchangeScreen__title">
            {utils.getLang("site__exchangeFeaturesTitle")}
          </h2>
          ...
          <div className="SiteExchangeScreen__interface">
            <div className="SiteExchangeScreen__interface__cont">
              <TitleWithBg
                title={utils.getLang("site__exchangeCustomizableInterface")}
                bgTitle={utils.getLang("site__exchangeCustomizableInterface")}
              />

              <p>{utils.getLang("site__exchangeCustomizableInterfaceTitle")}</p>

              <ul>
                <li>
                  <span>
                    {utils.getLang(
                      "site__exchangeCustomizableInterfaceSubTitle1"
                    )}
                  </span>
                </li>
                <li>
                  <span>
                    {utils.getLang(
                      "site__exchangeCustomizableInterfaceSubTitle2"
                    )}
                  </span>
                </li>
                <li>
                  <span>
                    {utils.getLang(
                      "site__exchangeCustomizableInterfaceSubTitle3"
                    )}
                  </span>
                </li>
                <li>
                  <span>
                    {utils.getLang(
                      "site__exchangeCustomizableInterfaceSubTitle4"
                    )}
                  </span>
                </li>
              </ul>
            ...
            <div className="SiteExchangeScreen__interface__img">
              <img
                src={require("./asset/exchange_main_image.png")}
  ...
  _renderFeatures() {
    ...
    return <div className="ExchangeFeature__items">{items}</div>;
  }
}
