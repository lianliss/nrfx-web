  ...
  return (
    <>
      <div className="SiteAboutScreen__intro">
        ...
        <p className="SiteAboutScreen__caption">{utils.getLang('site__aboutShortTitleText')}</p>
      </div>
      ...
      <div className="SiteAboutScreen__career">
        ...
        <p className="SiteAboutScreen__career__caption">{utils.getLang('site__aboutWorkBitcoinbotTitleText')}</p>
