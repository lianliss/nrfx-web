      ...
      <div>
        <div className="Layout_spacing">
          ...
          <div className="SiteCommerceScreen__intro">
            <TitleWithBg title={utils.getLang('site__commerceBitcoinbotTitle')} bgTitle={utils.getLang('site__commerceBitcoinbotTitle')} bgTitleUppercase centered />
          ...
          <div className="SiteCommerceScreen__features">
            <h2 className="SiteCommerceScreen__title">{utils.getLang('site__commerceBenefitsTitle')}</h2>
            <p className="SiteCommerceScreen__caption">{utils.getLang('site__commerceBenefitsSubTitle')}</p>

            {this._renderFeatures()}
          </div>


          <h2 className="SiteCommerceScreen__title">{utils.getLang('site__commerceHowItWorksTitle')}</h2>
          <p className="SiteCommerceScreen__caption">{utils.getLang('site__commerceHowItWorksSubTitle')}</p>
