...
export default class SiteInvestmentScreen extends BaseScreen {
      ...
      <div>
        <div className="Layout_spacing">
          ...
          <div className="SiteInvestmentScreen__intro">
            <TitleWithBg
              title={getLang("site__investmentWhatIsInvestmentTitle")}
              bgTitle={getLang("site__investmentWhatIsInvestmentTitle")}
              bgTitleUppercase
              centered
              darkBg
            />
          ...
          <h2 className="SiteInvestmentScreen__title">
            {getLang("site__investmentMoreThanDeposit")}
          </h2>
  ...
  _renderNumbers = () => {
    ...
    return dataWithNumbers.map(item => (
      <div key={item.title} className="SiteInvestmentScreen__numbers__item">
        <h2 className="SiteInvestmentScreen__numbers__item__title">
          {item.title}
        </h2>
        <p className="SiteInvestmentScreen__numbers__item__caption">
          {item.caption}
        </p>
      </div>
    ));
  ...
  _renderFeatures() {
    ...
    return <div className="InvestmentFeature__items">{items}</div>;
  }
}
