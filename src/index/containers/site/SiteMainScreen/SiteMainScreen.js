...
export default class SiteMainScreen extends BaseScreen {
  componentDidMount() {
    ...
    logEvent(getAnalytics(), "open_site_main_screen");
  }
  ...
  getAnimatedTitle = () => {
    ...
    return <TypedText products={products} />;
  };
      ...
      <div>
        ...
        <div className="Layout_spacing">
          ...
          <div className="SiteSectionHeader">
            <div className="SiteSectionHeaderTitle">
              {utils.getLang("site__homeBitcoibotCombine")}
            </div>
            <div className="SiteSectionHeaderCaption">
              {utils.getLang("site__homeBitcoibotCombineSubTitle")}
            </div>
          </div>
        </div>
        ...
        <div className="SiteHomepageProducts">
          <div className="Layout_spacing">
            ...
            >
              {[
                utils.getLang("site__homeExchangeSubTitile1"),
                utils.getLang("site__homeExchangeSubTitile2"),
                utils.getLang("site__homeExchangeSubTitile3")
              ]}
            </HomepageProduct>
            ...
            >
              {[
                utils.getLang("site__homeWalletSubTitle1"),
                utils.getLang("site__homeWalletSubTitle4"),
                utils.getLang("site__homeWalletSubTitle3")
              ]}
            </HomepageProduct>
        ...
        <div className="SiteMainScreen__safety">
          <div className="SiteSectionHeader">
            <div className="SiteSectionHeaderTitle">
              {utils.getLang("site__homeSecurityTitle")}
            </div>
            <div className="SiteSectionHeaderCaption">
              {utils.getLang("site__homeSecuritySubTitle")}
            </div>
          </div>
  ...
  _renderSafety() {
      ...
      return (
        <InfoCard
          ...
          btn={
            <a
              href={`/${item.route}`}
              className="SiteHomepageSafety__item__more"
            >
              {utils.getLang("site__homeLearnMore")}
            </a>
          }
        />
      );
    ...
    return <div className="SiteHomepageSafety__items">{items}</div>;
  }
}
