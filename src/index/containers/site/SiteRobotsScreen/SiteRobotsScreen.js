...
export default class SiteRobotsScreen extends BaseScreen {
      ...
      <div className="Robots__screen">
        <div className="Layout_spacing">
          <SitePageInfoBlock
            ...
            buttonText={utils.getLang("site__toTryBtn")}
          />

          <div className="SiteSectionHeader">
            <div className="SiteSectionHeaderTitle">
              {utils.getLang("site__robotsHowEarnMoreTitle")}
            </div>
            <div className="SiteSectionHeaderCaption">
              {utils.getLang("site__robotsHowEarnMoreSubTitle")}
            </div>
          </div>
  ...
  _renderFeatures() {
    ...
    return <div className="RobotsFeature__items">{items}</div>;
  }
}
