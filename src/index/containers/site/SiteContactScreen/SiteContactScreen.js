    ...
    >
      ...
      <div className="SiteContactScreen__sn__item__content">
        ...
        <a href={"https://" + props.link}>
          {props.displayLink || props.link.replace("https://", "")}
        </a>
      </div>
    </UI.ContentBox>
  ) : null;
      ...
      <div>
        ...
        <div className="SiteContactScreen Layout_spacing">
          ...
          <div className="SiteContactScreen__content">
            <TitleWithBg
              title={utils.getLang("site__contactSubTitle")}
              bgTitle={utils.getLang("site__contactSubTitleBackground")}
              centered
            />
            <p className="SiteContactScreen__description">
              {utils.getLang("site__contactDescription")}
            </p>
            ...
            <div className="SiteContactScreen__link_list">
              ...
              >
                ...
                <h3 className="SiteContactScreen__link_item__title">
                  {utils.getLang("site__contactChatTitle")}
                </h3>
              ...
              >
                ...
                <h3 className="SiteContactScreen__link_item__title">
                  {utils.getLang("site__contactFaqTitle")}
                </h3>
              ...
              <UI.ContentBox
                onClick={() => {
                  window.location.href = `mailto:${COMPANY.email.support}`;
                }}
                className="SiteContactScreen__link_item"
              >
            ...
            <TitleWithBg
              title={utils.getLang("site__contactSocialNetworksTitle")}
              bgTitle={utils.getLang(
                "site__contactSocialNetworksTitleBackground"
              )}
              centered
            />
            ...
            <TitleWithBg
              title={utils.getLang("site__contactTelegramTitle")}
              bgTitle={utils.getLang("site__contactTelegramTitleBackground")}
              centered
            />
