...
export class Web3Backend {
    ...
    getPrivateKey = (address, password) => this.get('wallet/privateKey', {params: {
        address, password,
    }});
    importWallet = (address, network = 'BEP20') => this.post('wallet/import', {params: {
        address, network,
    }});
    getBalances = address => this.get('wallet/balances', {params: {
        address,
    }});
}
